...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , persistent_toppartitions_publish_interval_sec(this, "persistent_toppartitions_publish_interval", liveness::LiveUpdate, value_status::Used, 10, "Controls how often the toppartitions results will be published to the logs.")
    , persistent_toppartitions_capacity(this, "persistent_toppartitions_capacity", liveness::LiveUpdate, value_status::Used, 256, "Controls the per shard capacity that will be used to calculate the toppartitions.")
    , persistent_toppartitions_list_size(this, "persistent_toppartitions_list_size", liveness::LiveUpdate, value_status::Used, 20, "Controls how many partitions per shard will be showed in the toppartitions results.")
    , persistent_toppartitions_sampling_probability(this, "persistent_toppartitions_sampling_probability", liveness::LiveUpdate, value_status::Used, 0, "Controls the probability of a query to be sampled. It must be a double between [0, 1] with 0 meaning that the feature is disabled and 1 meaning that 100% of the queries will be sampled")
